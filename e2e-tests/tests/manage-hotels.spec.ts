...
test("should edit hotel", async ({ page }) => {
  ...
  await expect(page.locator('[name="name"]')).toHaveValue("Ashraya Hotel");
  await page.locator('[name="name"]').fill("Ashraya Hotel updated");
  await page.getByRole("button", { name: "Save" }).click();
  await expect(page.getByText("Hotel Saved!")).toBeVisible();
  ...
  await expect(page.locator('[name="name"]')).toHaveValue(
    "Ashraya Hotel updated"
  );
  await page.locator('[name="name"]').fill("Ashraya Hotel");
  await page.getByRole("button", { name: "Save" }).click();
});
